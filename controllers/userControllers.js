...
// import  {broadCast}  from './../socket.cjs';
...
const apiXTranslate = async function (data, language, userid,res) {
    ...
    try {
        ...
        const result = await translate(data, {from: 'en', to: language, requestFunction: fetch});

        // const result = await translateme(data, { to: language, autoCorrect: true, rejectOnPartialFail: false , requestFunction: fetch})
